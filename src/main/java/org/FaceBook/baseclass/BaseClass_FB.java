...
public class BaseClass_FB {
	...
	public static WebDriver setproperty(String value) {
		if (value.equalsIgnoreCase("Chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Admin\\eclipse-workspace\\FaceBook\\driver\\chromedriver.exe");
	...
	public static void takesScreenShot(String path) throws IOException {
		...
		FileUtils.copyFile(source, dest); // to use this we need commons.io
		// FileHandler.copy(source, dest); // use anyone method either fileutils or
		// filehandler
	}
	...
	// checking multiselect dropdown or not and multiselecting options in the
	// dropdown
	...
	// checking multiselect dropdown or not and multideselecting options in the
	// dropdown
